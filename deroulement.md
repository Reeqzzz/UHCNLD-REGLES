...
Les joueurs choisissent leur équipe (item "Choisir une Équipe" dans la hotbar). L'item "Règles de la partie" (dernier slot de la hotbar) affiche les règles et les commandes utiles dans le chat, et la commande `/positions` affiche de son côté les positions du Temple, des donjons et des marchands.
